...
function SkillCard({ s, delay }: { s: (typeof skills)[0]; delay: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: s.color, fontSize: 15, lineHeight: 1 }}>
          {s.icon}
        </span>
        <span
          style={{
            ...
            fontSize: 11,
            color: hov ? "#fff" : "rgba(220,235,255,0.75)",
            fontWeight: 500,
      ...
      <div
        style={{
          fontFamily: "DM Mono, monospace",
          fontSize: 9,
          color: hov ? `${s.color}aa` : "rgba(148,163,184,0.38)",
    ...
    >
      ...
      <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            zIndex: 2,
            background:
              "linear-gradient(180deg, rgba(2,4,9,0.82) 0%, rgba(2,4,9,0.25) 20%, transparent 40%)",
          }}
        />
        {/* BOTTOM fade-out */}
        <div
          style={{
            ...
            zIndex: 2,
            background:
              "linear-gradient(0deg, rgba(2,4,9,1) 0%, rgba(2,4,9,0.75) 10%, rgba(2,4,9,0.12) 34%, transparent 52%)",
          }}
        />
        ...
        <div
          style={{
            ...
            zIndex: 2,
            background:
              "linear-gradient(90deg, transparent 35%, rgba(2,4,9,0.45) 65%, rgba(2,4,9,1) 100%)",
          }}
        />
        {/* LEFT trim */}
        <div
          style={{
            ...
            zIndex: 2,
            background:
              "linear-gradient(270deg, transparent 88%, rgba(2,4,9,0.5) 100%)",
          }}
        />
        ...
        <div
          style={{
            ...
            zIndex: 3,
            background:
              "linear-gradient(160deg, rgba(37,99,235,0.08) 0%, rgba(96,165,250,0.02) 50%, rgba(37,99,235,0.06) 100%)",
          }}
        />
      </div>
      ...
      <motion.div
        ...
        style={{
          ...
          width: 2.5,
          background:
            "linear-gradient(180deg, transparent, #60a5fa 30%, #3b82f6 70%, transparent)",
          transformOrigin: "top",
          zIndex: 10,
        }}
      />
      ...
      {[
        {
          ...
          borderLeft: "1.5px solid rgba(96,165,250,0.55)",
        },
        {
          bottom: 22,
          left: 14,
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            style={{
              background:
                "linear-gradient(90deg, #60a5fa 0%, #93c5fd 40%, #3b82f6 100%)",
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(180deg, rgba(2,4,9,0.6) 0%, transparent 26%, transparent 52%, rgba(2,4,9,0.9) 86%, rgba(2,4,9,1) 100%)",
              }}
            />
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(90deg, rgba(2,4,9,0.35) 0%, transparent 16%, transparent 84%, rgba(2,4,9,0.35) 100%)",
              }}
            />
            <div
              style={{
            ...
            <div
              style={{
                ...
                borderLeft: "1.5px solid rgba(96,165,250,0.5)",
              }}
            />
            <div
              style={{
                ...
                height: 18,
                borderTop: "1.5px solid rgba(96,165,250,0.5)",
                borderRight: "1.5px solid rgba(96,165,250,0.5)",
              }}
            />
            <div
              style={{
                ...
                width: 18,
                height: 18,
                borderBottom: "1.5px solid rgba(96,165,250,0.5)",
                borderLeft: "1.5px solid rgba(96,165,250,0.5)",
              }}
            />
            <div
        ...
        >
          From blueprint to byte — bridging systems architecture and modern
          engineering to build things that are clean, scalable, and built to
          last.
        </motion.p>
        ...
        >
          {[
            { t: 11, label: "Systems Designed" },
            { t: 8, label: "Projects Shipped" },
          ].map((s, i) => (
            <div key={s.label}>
              <div
                style={{
              ...
              >
                <Counter
                  target={s.t}
                  delay={(mobile ? 1400 : 1600) + i * 120}
                />
                <span style={{ color: "#60a5fa", fontSize: mobile ? 26 : 32 }}>
                  +
                </span>
              </div>
              <div
          ...
          {/* ✅ Marquee — was broken, now a proper motion.div */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: mobile ? 1.3 : 1.45 }}
      ...
      .tech-track { display: flex; width: max-content; animation: marquee 24s linear infinite; }
      .tech-track:hover { animation-play-state: paused; }
      .tech-chip {
        display: inline-flex; align-items: center; gap: 8px;
        padding: 6px 16px; margin: 0 5px;
        background: rgba(255,255,255,0.03);
        border: 0.5px solid rgba(96,165,250,0.13); border-radius: 8px;
        font-family: 'DM Mono', monospace; font-size: 10px;
        letter-spacing: 0.06em; color: rgba(148,163,184,0.55);
        white-space: nowrap; cursor: default;
        transition: all 0.2s ease;
      }
      .tech-chip:hover { border-color: rgba(96,165,250,0.35); color: rgba(200,220,255,0.85); background: rgba(96,165,250,0.07); }
      .tech-chip img { width: 15px; height: 15px; object-fit: contain; opacity: 0.7; }
        ...
        >
          <button
            ...
            style={{
              ...
              letterSpacing: "0.08em",
              boxShadow:
                "0 0 24px rgba(37,99,235,0.35), 0 4px 14px rgba(0,0,0,0.35)",
              flex: mobile ? "1" : "unset",
            }}
          >
            View Work
