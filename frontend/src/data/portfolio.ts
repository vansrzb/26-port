...
export const projects = [
   {
    ...
    description:
      "A QR-based attendance system that enables teachers to quickly record attendance and reduces attendance processing time by over 80%.",
    tags: ["TypeScript", "Node.js", "Express", "MySQL"],
    date: null,
    role: "Full-Stack Developer",
    link: "#",
    github: "https://github.com/vansrzb/client-attendance-system",
  ...
  },
  {
    ...
    link: "#",
    github:
      "https://github.com/kevinbalocos/customer-relationship-management-system",
...
export const education = [
  {
    ...
    gpa: "3.7",
    description:
      "Graduated with honors. Specialized in software development and systems analysis. Capstone project focused on evaluation systems for Schools.",
